...
/// </summary>
public class SetDataMultiResponseServiceData : IDictionary<string, CodeDataPair>, IDictionary
{
    private readonly Dictionary<string, CodeDataPair> _dataToSend = new();
